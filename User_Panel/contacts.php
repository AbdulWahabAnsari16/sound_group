			...
			<div class="row row--grid">
				...
				<div class="col-12 col-md-6 col-lg-5 col-xl-4">
					...
					<ul class="contacts__list">
						...
						<li><a href="mailto:support@Sound_Group.template">support@gmail.com</a></li>
						<li><a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom" class="open-map">Address/xyz/XYZ</a></li>
					</ul>
