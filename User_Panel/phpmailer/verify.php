...
<!-- Mirrored from Sound_Group.volkovdesign.com/signin.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 07:19:11 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
	...
	<div class="sidebar">
		...
		<ul class="sidebar__nav">
			...
			<li class="sidebar__nav-item">
				<a href="#" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.65,2.24a1,1,0,0,0-.8-.23l-13,2A1,1,0,0,0,7,5V15.35A3.45,3.45,0,0,0,5.5,15,3.5,3.5,0,1,0,9,18.5V10.86L20,9.17v4.18A3.45,3.45,0,0,0,18.5,13,3.5,3.5,0,1,0,22,16.5V3A1,1,0,0,0,21.65,2.24ZM5.5,20A1.5,1.5,0,1,1,7,18.5,1.5,1.5,0,0,1,5.5,20Zm13-2A1.5,1.5,0,1,1,20,16.5,1.5,1.5,0,0,1,18.5,18ZM20,7.14,9,8.83v-3L20,4.17Z"/></svg> <span>Releases</span></a>
			</li>
			...
			<li class="sidebar__nav-item">
				...
				<div class="collapse" id="">
					<ul class="sidebar__menu sidebar__menu--scroll">
						...
						<li><a href="phpmailer/signup.php">Sign up</a></li>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© Sound_Group, 2021. Created by <a href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Dmitry Volkov</a>.</small>
					</div>
				</div>
			</div>
		</div>
