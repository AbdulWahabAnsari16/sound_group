...
if(isset($_POST['verify'])){
    $code  = $_POST['vcode'];
    $sql = "SELECT * FROM `forgotpass` where u_v_code = '$code'";
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© Sound_Group, 2024. Created by <a href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Dmitry Volkov</a>.</small>
					</div>
				</div>
			</div>
		</div>
